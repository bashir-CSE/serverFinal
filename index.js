...
async function run() {
	...
	try {
		...
		app.post("/appointments", async (req, res) => {
			const vaccine = req.body;
			const result = await appointmentsCollection.insertOne(vaccine);
			// console.log(result);
			res.json(result);
		});
...
const users = [
	{
		...
		name: "Diabetes ",
		description:
			"Diabetes mellitus, commonly known as diabetes, is a metabolic disease that causes a person’s blood sugar level (also called blood glucose) is too high. Most of the food you eat is broken down ",
